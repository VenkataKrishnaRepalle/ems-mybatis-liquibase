...
//
//        when(employeeDao.get(employeeUuid)).thenReturn(notNull());
//
//        Employee result = employeeService.getById(employeeUuid);
//        assertEquals(employee, result);
//
//        verify(employeeDao, times(1)).get(eq(employeeUuid));
//    }
//
//    @Test
